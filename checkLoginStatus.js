...
{  
  ...
  document.getElementById("jdiv").innerHTML = '<h1>UNLEASHED PET FINDER: </h1>\n<h3>Please choose option</h3>\n<div class="col-sm-12" id="jumbotron-content">\n<button id="btn_download1"class="btn btn-primary btn btn-lg">Search for Lost Pet</button>\n<script type="text/javascript">$("#btn_download1").click(function(){window.open("/search.html");})</script>\n<button id="btn_download2"class="btn btn-primary btn btn-lg">Report a Lost Pet</button>\n<script type="text/javascript">$("#btn_download2").click(function(){window.open("/report-found.html");})</script>\n<button id="btn_download3"class="btn btn-primary btn btn-lg">My Pet Profile</button>\n<script type="text/javascript">$("#btn_download3").click(function(){window.open("/pet-profiles.html");})</script>\n</div>\n<br/>';
